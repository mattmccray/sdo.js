...
(function() {
  var Hash, List, Model, arrayWithout, arrayWithoutArray, clone, defaults, extend, hasKey, isBlank, makeArray, resultFor, type, uid, _Evented, _slice, _toString,
  ...
  arrayWithoutArray = function(source, target) {
  ...
  Model = (function(_super) {
    ...
    function Model(atts, callback) {
      if (type(atts) === 'function') {
        callback = atts;
        atts = {};
      }
      atts || (atts = {});
      Model.__super__.constructor.call(this, callback);
    ...
    Model.prototype.set = function(key, value) {
      if (type(key) === 'string') {
        ...
        extend(this.atts, key);
        return this._changed(_.keys(key));
      }
    };
    ...
    Model.prototype.toProps = function() {
      return clone(this.atts);
    };
  ...
  Hash = (function(_super) {
    ...
    Hash.prototype.add = function(key, model) {
